...
def tear_sheet(data,freq="M"):
    ...
    for x in unique_years:
        ...
        tear_sheet.append([x,a,b,c,d,e,f,g])
    
    tear_sheet=np.array(tear_sheet)

    tear_sheet_disp=pd.DataFrame(data=tear_sheet, columns=["Year", "Mean Monthly Return", "Volatility", "Yearly Return", "Cummulative Return","Sharpe", "Sortino", "Max Drawdown"],)
